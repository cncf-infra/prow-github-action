...
type ClientOptions struct {
	...
	IsGithubAction bool // guards GithubAPI calls not permitted by emphemeral token granted to a Github Action
...
func NewClientFromOptions(fields logrus.Fields, options ClientOptions) (TokenGenerator, UserGenerator, Client, error) {
	...
	c := &client{
		...
		delegate: &delegate{
			...
			usesGithubActionToken: options.IsGithubAction,
